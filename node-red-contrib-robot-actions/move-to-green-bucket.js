module.exports = function(RED) {
    function Node(config) {
        ...
        node.on('input', function(msg) {
            ...
            const action = {"action":"move_to_position","position":{"x_coord": -0.69,"y_coord": -0.48,"z_coord": 0.8},"duration": 2, "name": "green_bucket"};
            actions.push(action);
            flow.set('actions', actions);
            msg.payload = actions;
            console.log(actions);
    ...
    RED.nodes.registerType("move to green bucket", Node);
};
